...
import net.tywrapstudios.agriculture.common.block.custom.BlackCarrotCrop;

public class BlockRegistry {


    public static final Block BLACK_CARROT = Registry.register(Registries.BLOCK, new Identifier(Tywragriculture.MOD_ID, "black_carrot_crop"),
            new BlackCarrotCrop(FabricBlockSettings.copyOf(Blocks.CARROTS)));
