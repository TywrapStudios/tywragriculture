...
public abstract class AbstractOvenBlock extends BlockWithEntity {
    ...
    protected AbstractOvenBlock(AbstractBlock.Settings settings) {
        super(settings);
    ...
    @Nullable
    protected static <T extends BlockEntity> BlockEntityTicker<T> checkType(World world, BlockEntityType<T> givenType, BlockEntityType<? extends AbstractOvenBlockEntity> expectedType) {
        return world.isClient ? null : checkType(givenType, expectedType, AbstractOvenBlockEntity::tick);
    }
