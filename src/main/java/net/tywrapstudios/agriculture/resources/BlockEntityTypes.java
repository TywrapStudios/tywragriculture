...
import net.tywrapstudios.agriculture.content.block.kitchen.OvenBlock;
...
public class BlockEntityTypes {
    ...
    static {
        ...
        OVEN = create("oven", BlockEntityType.Builder.create(OvenBlockEntity::new, BlockRegistry.OVEN.get()));
    }
